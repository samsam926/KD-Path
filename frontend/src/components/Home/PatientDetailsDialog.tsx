import { Activity, Calendar, TrendingDown, User } from "lucide-react"
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <div className="flex items-start justify-between">
            ...
            <Badge className={`${alert.color} text-white`}>{alert.level}</Badge>
          </div>
        </DialogHeader>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="col-span-2">
                ...
                <p className="font-semibold">
                  {patient.visits?.length || 0} clinical visits
                </p>
              </div>
            </div>
          </Card>
          ...
          <Card className="p-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              ...
              <div className="p-3 bg-gray-50 rounded-lg">
                ...
                <p className="text-xl font-bold text-healthcare-primary">
                  {patient.vitals?.acr}{" "}
                  <span className="text-sm font-normal">mg/g</span>
                </p>
              </div>
            </div>
          </Card>
