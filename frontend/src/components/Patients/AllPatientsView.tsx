                  ...
                  {patients.map((patient) => (
                    <TableRow key={patient.id}>
                      ...
                      <TableCell>
                        <Badge
                          variant="outline"
                          className="border-healthcare-accent text-healthcare-accent"
                        >
                          {patient.ward}
                        </Badge>
                      </TableCell>
            ...
            <Card className="p-6">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Enter Patient ID to retrieve vital signs
                  </p>
                </div>
              </div>
            ...
            {selectedPatientVitals && (
              <Card className="p-6">
                <div className="mb-4">
                    ...
                    {selectedPatientVitals.status && (
                      <Badge
                        className={
                          ...
                          selectedPatientVitals.status === "FastCKD uncertainty"
                  ...
                  <p className="text-sm text-muted-foreground">
                    ID: {selectedPatientVitals.id} | Ward:{" "}
                    {selectedPatientVitals.ward}
                  </p>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between items-center p-3 bg-healthcare-light/20 rounded-lg">
                    ...
                    <span className="font-semibold text-healthcare-primary">
                      {selectedPatientVitals.vitals.bloodPressureSys}/
                      {selectedPatientVitals.vitals.bloodPressureDia} mmHg
                    </span>
                  </div>
                  <div className="flex justify-between items-center p-3 bg-healthcare-light/20 rounded-lg">
                    <span className="text-sm text-muted-foreground">
            ...
            <Card className="p-6">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Enter Patient ID to retrieve details
                  </p>
                </div>
              </div>
        ...
        <DialogContent className="max-w-6xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle className="text-healthcare-primary">
              {kidneyDetailsPatient?.name} - Comprehensive Kidney Health
              Assessment
            </DialogTitle>
          </DialogHeader>
          {kidneyDetailsPatient && (
            <PatientKidneyDetails patient={kidneyDetailsPatient} />
          )}
        </DialogContent>
      </Dialog>
    </div>
